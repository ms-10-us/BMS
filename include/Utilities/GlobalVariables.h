...
struct GlobalVariables
{
    ...
    double GlobalV1 = 0.0;                   // volts
    double GlobalVoltage = 0.0;              // volts
    double GlobalCurrent = 0.0;              // current
    double dOCV_dSOC = 0.0;                  // no units
    ...
    double GlobalTemperatureIncrease = 0.0;  // degC
